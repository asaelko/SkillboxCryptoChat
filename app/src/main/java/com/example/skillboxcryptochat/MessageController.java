...
public class MessageController extends RecyclerView.Adapter {
    ...
    public static class Message {
        ...
        public Message(String text, String userName, Boolean isOutgoing, Boolean isSystem) {
            this.text = text;
            this.userName = userName;
            this.date = new Date();
            this.isOutgoing = isOutgoing;
    ...
    public MessageController setSystemLayout(int systemLayout) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int view_type) {
        ...
        switch (view_type) {
            case TYPE_OUTGOING:
                ...
                break;
            case TYPE_SYSTEM:
                view = LayoutInflater.from(viewGroup.getContext()).inflate(systemLayout, viewGroup, false);
                break;
            default:
